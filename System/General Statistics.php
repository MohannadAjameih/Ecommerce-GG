        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-12">
                <div class="small-box bg-light shadow-sm border">
                    <div class="inner">
                        <h3>
                            <?php echo $conn->query("SELECT  *From users $where")->num_rows; ?>
                        </h3>
                        <p>Total Employees</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-12 col-sm-6 col-md-12">
                <div class="small-box bg-light shadow-sm border">
                    <div class="inner">
                        ...
                        <p>All Unread Massages</p>
                    </div>
                    <div class="icon">
                        <i class="fas bi-chat-left-dots-fill"></i>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-12">
                <div class="small-box bg-light shadow-sm border">
                    <div class="inner">
                        <h3>
                            <?php echo $conn->query("SELECT  *From careers where REMARKS='0'")->num_rows; ?>
                        </h3>
                        <p>Number of job applications</p>
                    </div>
                    <div class="icon">
                        <i class="fas bi-person-rolodex"></i>
                    </div>
                </div>
            </div>
        </div>
